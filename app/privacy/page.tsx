      ...
      <div className="space-y-10">
        ...
        <Section no={2} title="카메라 영상의 처리">
          ...
          <p>
            ...
            종료하면 즉시 중단됩니다. 이용자는 카메라 권한을 허용하지 않고도
            수동 타이머 방식으로 서비스를 이용할 수 있습니다.
          </p>
        </Section>
        ...
        <Section no={4} title="보유 및 이용 기간">
          <p>
            ...
            데이터 삭제를 실행하거나 아래 연락처로 삭제를 요청하면 지체 없이
            파기합니다.
          </p>
          <p>
        ...
        <Section no={5} title="파기 절차 및 방법">
          ...
          <ul className="list-disc space-y-1.5 pl-5">
            ...
            <li>
              이용자의 삭제 요청: 이용자가 앱 내 설정에서 데이터 삭제를
              실행하면, 해당 기기 식별자와 이에 연결된 모든 공부 기록이
              서버에서 즉시 삭제됩니다.
            </li>
          </ul>
          <p>
        ...
        <Section no={9} title="이용자의 권리와 행사 방법">
          <p>
            이용자는 언제든지 자신의 공부 기록을 조회·수정·삭제할 수
            있습니다.
          </p>
          <p>
            서비스는 익명 기기 식별자를 기준으로 운영되므로, 앱이 설치된
            기기에서 직접 삭제를 실행하는 것이 가장 확실한 방법입니다. 앱 내
            설정 &gt; 데이터 관리 &gt; 모든 데이터 삭제를 통해 서버에 저장된
            기록까지 함께 삭제할 수 있습니다.
          </p>
          <p>
            앱을 사용할 수 없는 상황이라면 아래 연락처로 요청해 주시기
            바랍니다. 다만 서비스가 실명이나 연락처를 보관하지 않으므로, 본인
            확인을 위해 해당 기기의 식별자 정보가 필요할 수 있습니다.
          </p>
          <p>
