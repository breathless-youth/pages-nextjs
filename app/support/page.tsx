    ...
    <main className="mx-auto w-full max-w-2xl px-5 py-16 md:py-24">
      ...
      <div className="space-y-8">
        <Faq
          ...
          a="네. 카메라 권한을 거부해도 수동 타이머 모드로 순공 시간 측정과 통계·스트릭 기능을 모두 이용할 수 있습니다. 설정 > 측정 방식에서 전환할 수 있습니다."
        />
        <Faq
          q="카메라 영상이 서버에 저장되나요?"
          a="아니요. 카메라 영상은 기기 안에서만 실시간으로 분석되며, 영상이나 사진이 저장되거나 서버로 전송되는 일은 없습니다. 서버에는 분석 결과인 상태 이벤트 기록(집중, 자리 비움 등)만 저장됩니다."
        />
        <Faq
          q="집중 상태 감지가 잘 안 돼요."
          a="기기를 책상에 세워 얼굴이 화면 중앙에 들어오도록 배치하고, 조명이 너무 어둡거나 역광인 환경을 피해 주세요. 그래도 인식이 어렵다면 수동 타이머 모드를 이용하실 수 있습니다."
        />
        <Faq
        ...
        <Faq
          q="내 데이터를 전부 지우고 싶어요."
          a="앱 내 설정 > 데이터 관리 > 모든 데이터 삭제를 실행하면 서버에 저장된 기록까지 즉시 삭제됩니다. 앱을 사용할 수 없는 상황이라면 위 이메일로 삭제를 요청해 주세요."
        />
      </div>
